...
public record CatOneResponse(
	...
	public record BreedResponse(
		@JsonProperty("weight") com.ys.cat_picture.infra.client.response.BreedResponse.Weight weight,
		@JsonProperty("id") String id,
		...
		@JsonProperty("cat_friendly") int catFriendly,
		...
		@JsonProperty("natural") int natural,
